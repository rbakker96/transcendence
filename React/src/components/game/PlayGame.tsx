        ...
        <main className="PlayGame_component">
            <div className="gameInfo">
                ...
                <div className="buttonsDiv">
                    ...
                    <Link to="/enableTwoFactor" type="button" className="w-100 btn btn-lg btn-primary">Play classic pong</Link>
                </div>
                <div className="buttonsDiv">
                    <p>The deluxe pong is with two powerups, each powerup can be used 3 times. First to 10 wins!</p>
                    <Link to="/enableTwoFactor" type="button" className="w-100 btn btn-lg btn-primary">Play deluxe pong</Link>
                </div>
            </div>
        </main>
    )
